...
export const BATTLE_TERRAIN_LAYERS: readonly BattleTerrainLayerSpec[] = [
  {
    ...
    path: 'battle_terrain_base_720x1280',
    width: 720,
    height: 1280,
    x: 0,
    y: 0,
