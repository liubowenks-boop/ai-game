...
| `fx_v2_gold_projectile.png` | `512x128` | `80-180` | 金色穿刺弹道 | 不做九宫格 | 弓手/主角 |
| `fx_v2_fire_slash.png` | `512x256` | `96-220` | 赤金火焰斩击 | 不做九宫格 | 主角/火药师 |
| `fx_v2_thunder_bolt.png` | `512x128` | `90-220` | 蓝紫分支闪电 | 不做九宫格 | 雷法师/雷链 |
| `fx_v2_thunder_impact.png` | `512x512` | `96-220` | 蓝紫雷爆冲击 | 不做九宫格 | 雷法师命中/雷链暴击 |
| `fx_v2_ice_shard.png` | `256x128` | `64-140` | 蓝白冰晶弹道 | 不做九宫格 | 冰法师 |
| `fx_v2_poison_wisp.png` | `256x256` | `48-128` | 绿紫毒咒能量 | 不做九宫格 | 毒师/咒术师 |
| `fx_v2_heal_orb.png` | `256x256` | `48-128` | 青绿治疗灵气 | 不做九宫格 | 治疗师 |
| `fx_v2_shield_impact.png` | `256x256` | `56-144` | 金属盾击冲击 | 不做九宫格 | 护卫 |
| `fx_v2_hit_star.png` | `256x256` | `40-120` | 通用星芒命中 | 不做九宫格 | 通用命中/暴击 |
| `fx_v2_smoke_debris.png` | `256x256` | `56-150` | 烟尘石屑爆散 | 不做九宫格 | 城墙/重击 |
| `fx_v2_rune_marker.png` | `256x128` | `72-128` | 临时放置符文 | 不做九宫格 | 空垛口放置提示 |
| `fx_v3_hit_fire_eruption.png` | `512x512` | `120-260` | 火焰裂地爆发、白热核心与岩屑 | 不做九宫格 | 主角/火系命中 |
| `fx_v3_hit_thunder_crater.png` | `512x512` | `120-260` | 蓝紫雷霆裂地与晶片冲击 | 不做九宫格 | 雷法/冰系命中 |
| `fx_v3_hit_poison_talisman.png` | `512x512` | `120-260` | 翠绿毒爆、符箓与烟雾 | 不做九宫格 | 毒师/咒术命中 |
| `fx_v3_hit_gold_starburst.png` | `512x512` | `120-260` | 白金星爆、冲击环与碎石 | 不做九宫格 | 金系/护卫命中 |
